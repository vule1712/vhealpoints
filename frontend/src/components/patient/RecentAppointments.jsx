...
const RecentAppointments = () => {
    ...
    useEffect(() => {
        if (socket.connected) {
            console.log('Patient RecentAppointments: Setting up socket listener');
            
            const handleDashboardUpdate = () => {
                console.log('Patient RecentAppointments: Received dashboard update, refreshing data');
            ...
            return () => {
                console.log('Patient RecentAppointments: Cleaning up socket listener');
                socket.off('patient-dashboard-update', handleDashboardUpdate);
            };
        } else {
            console.log('Patient RecentAppointments: Socket not connected, waiting...');
            const handleConnect = () => {
                console.log('Patient RecentAppointments: Socket connected, setting up listener');
                const handleDashboardUpdate = () => {
                    console.log('Patient RecentAppointments: Received dashboard update, refreshing data');
                    fetchRecentAppointments();
                };
